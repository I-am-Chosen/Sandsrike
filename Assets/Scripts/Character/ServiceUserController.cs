...
namespace HEAVYART.TopDownShooter.Netcode
{
    ...
    public class ServiceUserController : NetworkBehaviour
    {
        ...
        private IEnumerator SpawnPlayerObject()
        {
            ...
            GameManager.Instance.spawnControl.SpawnPlayerServerRpc(GetSerializedPlayerSpawnParameters());
        }

        public string GetSerializedPlayerSpawnParameters()
        {
            ...
            return JsonConvert.SerializeObject(spawnParameters);
        }
    }
}
