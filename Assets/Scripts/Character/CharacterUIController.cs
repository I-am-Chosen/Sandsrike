    ...
    public class CharacterUIController : NetworkBehaviour
    {
        ...
        public override void OnNetworkSpawn()
        {
            ...
            if (identityControl.IsLocalPlayer == false)
            {
                ...
                if (identityControl.isPlayer == true)
                    statusBarUIController.ShowUserName(identityControl.spawnParameters.name);
            }
        }
        ...
        private void FixedUpdate()
        {
            ...
            if (identityControl.IsLocalPlayer == true) //Use HUD
            {
                ...
                GameManager.Instance.UI.hudStatusBar.UpdatePowerUpIndicators(commandsControlSystem, true);
            }
            else //Use status bar (above head)
            {
                ...
                statusBarUIController.UpdatePowerUpIndicators(commandsControlSystem, true);
            }
        }
    }
}
