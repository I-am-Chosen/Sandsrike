...
{
    public class CharacterDeathController : NetworkBehaviour
    {
        public float delayBeforeDrop = 1;
        public float delayBeforeStartMoving = 2;
        public float delayBeforeDestroy = 1;
        ...
        IEnumerator ProcessCharacterDestroySteps(bool stopCameraMovement)
        {
            ...
            Transform lineOfSight = GetComponent<WeaponControlSystem>().lineOfSightTransform;
            Destroy(lineOfSight.GetComponent<BasicNetworkTransform>());
