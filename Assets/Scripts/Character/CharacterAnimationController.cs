...
namespace HEAVYART.TopDownShooter.Netcode
{
    public class CharacterAnimationController : MonoBehaviour
    {
        ...
        void LateUpdate()
        {
            ...
            animator.SetFloat("MovementSpeedMultiplier", CalculateSpeedMultiplier());
        ...
        private void HandleAiming(Transform bone, float weight)
        {
            ...
            Vector3 direction = targetingTransform.position - lineOfSightTransform.position;
            direction.Normalize();

            Quaternion boneRotation = Quaternion.FromToRotation(animator.transform.forward, direction);
