...
namespace HEAVYART.TopDownShooter.Netcode
{
    public class LobbyActivityControl
    {
        ...
        private float lobbyHeartbeatRate;

        private float waitForPlayersToInitializeDelay;
        private float waitForPlayersReadyResponseDelay;
        private float waitForPlayersToRemoveDelay;
        ...
        public async void StartNewGame()
        {
            ...
            await Awaitable.WaitForSecondsAsync(waitForPlayersToInitializeDelay);
            ...
            await Awaitable.WaitForSecondsAsync(waitForPlayersReadyResponseDelay);
            ...
            else
            {
                ...
                await Awaitable.WaitForSecondsAsync(waitForPlayersToRemoveDelay);
        ...
        public async void RunLobbyHeartbeatLoop()
        {
            while (Application.isPlaying)
            {
                ...
                await Awaitable.WaitForSecondsAsync(lobbyHeartbeatRate);
            }
        }
