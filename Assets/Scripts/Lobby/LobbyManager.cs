...
namespace HEAVYART.TopDownShooter.Netcode
{
    public class LobbyManager : Singleton<LobbyManager>
    {
        ...
        /// <summary>
        /// Connect directly to a dedicated server, bypassing Unity Relay/Lobby.
        /// Call from the main menu when the player clicks "Connect to Server".
        /// </summary>
        public void ConnectToDedicatedServer()
        {
            isOfflineMode = false;
            DirectConnectionManager.Instance.Connect();
        }

        /// <summary>Connect to a specific address/port (useful for LAN / custom servers).</summary>
        public void ConnectToDedicatedServer(string address, ushort port)
        {
            isOfflineMode = false;
            DirectConnectionManager.Instance.Connect(address, port);
        }
