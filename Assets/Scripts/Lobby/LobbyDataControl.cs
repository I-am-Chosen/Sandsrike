    ...
    public class LobbyDataControl
    {
        ...
        private async void ProcessInitialization()
        {
            ...
            if (AuthenticationService.Instance.IsSignedIn == false)
            {
                ...
                {
                    AuthenticationService.Instance.SwitchProfile("WebGLPlayer");
                    PlayerDataKeeper.authProfileName = "WebGLPlayer";
                }
        ...
        public async void RunLobbyAutoRefreshLoop()
        {
            ...
            {
                await Awaitable.WaitForSecondsAsync(SettingsManager.Instance.lobby.autoRefreshRate);
